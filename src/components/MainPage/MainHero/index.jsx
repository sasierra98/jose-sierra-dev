...
export const MainHero = () => {
  ...
  return (
    ...
    >
      {/* <NavBar />   */}
      <Grid
        className="flex text-left justify-center xl:px-40"
        container
        spacing={2}
        columns={{ sm: 12 }}
      >
          ...
          <Box className="w-full break-words px-5">
            ...
            <Fade in={checked} timeout={1500}>
              ...
              >
                ...
                donec gravida <br /> id sed senectus dolor cursus sed.
                Ullamcorper tellus ac cras nec, pretium <br /> laoreet duis.
              </Typography>
            </Fade>
